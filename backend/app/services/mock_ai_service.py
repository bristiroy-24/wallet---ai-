...
# ── Keyword → (category, subcategory) mappings ───────────────────────────────
# Subcategory names must match DEFAULT_CATEGORIES in app/db/seed.py exactly.
_CATEGORY_KEYWORDS: list[tuple[str, str | None, list[str]]] = [
    ...
    ("Entertainment", "Gaming",             ["gaming", "hotstar", "disney"]),
    ("Entertainment", None,                 ["subscription"]),
    ...
    ("Housing",       "Internet / Wi-Fi",   ["wifi", "wi-fi", "broadband", "internet bill"]),
    ("Housing",       None,                 ["rent", "maintenance", "water bill"]),
    ("Recharge",      "Phone Recharge",     ["recharge", "airtel", "jio", "vi", "bsnl"]),
    ("Recharge",      "Wi-Fi Bill",         ["wifi recharge", "wi-fi recharge"]),
    ("Shopping",      "Amazon / Flipkart",  ["amazon", "flipkart", "myntra", "meesho"]),
    ("Shopping",      "Personal Care",      ["personal care", "nykaa", "skincare"]),
    ("Shopping",      None,                 ["clothes", "shoes", "electronics", "gadget"]),
    ("Education",     "Courses",            ["udemy", "coursera", "course"]),
    ("Education",     "Books",              ["book", "kindle"]),
    ("Education",     None,                 ["school", "tuition", "college"]),
    ("Health",        "Pharmacy",           ["medicine", "pharmacy", "chemist", "medplus"]),
    ("Health",        "Doctor",             ["doctor", "clinic", "hospital"]),
    ("Investments",   "Mutual Funds",       ["mutual fund", "sip", "zerodha", "groww"]),
    ("Investments",   "Stocks",             ["stocks", "shares", "nse", "bse"]),
    ("Investments",   None,                 ["investment", "fd", "fixed deposit"]),
    ("Lifestyle",     "Gym",                ["gym", "fitness", "yoga"]),
    ("Lifestyle",     "Salon",              ["salon", "haircut", "spa"]),
    ("Lifestyle",     "Dining Out",         ["dining", "date night", "fine dining"]),
]
